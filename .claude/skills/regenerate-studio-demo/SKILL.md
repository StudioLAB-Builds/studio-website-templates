...
3. **New design direction** (optional, text): "The new design direction to use, or leave blank to let Claude pick something different"
...
- `status`: "visible"
- `source`: `"Claude regenerated demo, {today's date}, iteration of previous {old-direction-name}"`
